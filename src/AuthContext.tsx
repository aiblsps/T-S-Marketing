...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // CRITICAL: Force loading to false after a very short timeout
    ...
    const unsubscribe = onAuthStateChanged(auth, (firebaseUser) => {
      ...
      if (firebaseUser) {
        ...
        const specialAdmins = ["aspsbazar@gmail.com", "cmrabbicarromking@gmail.com", "shanubegumts@gmail.com", "balkoy72@gmail.com", "mohammadrabbi617@gmail.com", "sardercreditunion@gmail.com"];
