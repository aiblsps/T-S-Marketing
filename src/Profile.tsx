      ...
      if (formData.email !== auth.currentUser.email) {
        try {
          ...
          if (err.code === 'auth/operation-not-allowed') {
            throw new Error("Email change is restricted. Please enable 'Email address change' in Firebase Console -> Authentication -> Settings -> User account linking.");
          }
          throw err;
        }
      }
      ...
      <div className="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 overflow-hidden">
        <div className="bg-[#003366] p-8 flex flex-col items-center text-white space-y-4">
          ...
          <div className="text-center">
            <h3 className="text-xl font-black">{user?.name || t('user')}</h3>
